...
SECRET_KEY = 'django-insecure-!9%s0ayhqf%cvkt1-aclhr16eyy3w+3+knv6ma92l+1qgeeez0'
...
MEDIA_ROOT = BASE_DIR/'register/static/uploads'
MEDIA_URL = '/uploads/'
...
CKEDITOR_UPLOAD_PATH = 'articles/upload/'
